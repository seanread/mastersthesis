...
The basis of any in depth investigation into the relationship between geometric variations and airflow structures is a clear analysis of the geometric variations. Various demographic factors have been suggested to influence nasal morphology, such as ethnicity (as a result of climatic adaptations on the nose) \cite{Davies1932, Thomson1923, Weiner1954, Churchill2004, Noback2011}. The nasal shape and form was naturally optimised for maintaining sufficient respiratory heat and moisture exchange in the nasal mucosa.
...
\begin{figure}
  \centering
  \includegraphics[width=0.5\textwidth]{pressureDrop.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{wencont.png}

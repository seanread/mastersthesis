...
\begin{figure} 
  ...
  \caption{Streamlines through the cavities and sagittal contours taken at the nasal valve, turbinal region and choannae, coloured by velocity magnitude, normalised with respect to each cavity's maximum velocity.}
  \label{fig:velcont}
\end{figure}
